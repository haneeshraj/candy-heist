...
const Form = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={clsx(styles["form__content"], styles["form__content--lg"])}
        >
          <WordAnimation
        ...
        <div
          className={clsx(styles["form__content"], styles["form__content--mb"])}
        >
          <WordAnimation
            text="So, You wanna collab or got some really cool ideas?"
            className={styles["form__heading"]}
